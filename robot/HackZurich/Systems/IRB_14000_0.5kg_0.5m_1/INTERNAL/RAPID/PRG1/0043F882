MODULE Gripper_R
    ...
    PROC rGrVacuumOn()
        !WaitTime 0.2;
        SetDO hand_CmdVacuum1_R,1;
        WaitTime 0.5;
    ENDPROC

    PROC rGrVacuumOff()
        !WaitTime 0.2;
        SetDO hand_CmdVacuum1_R,0;
        SetDO hand_CmdBlowoff1_R,1;
        WaitTime 0.02;
        SetDO hand_CmdBlowoff1_R,0;
        WaitTime 0.5;
    ENDPROC

    PROC rGrServoClose()
        IF bSimulation THEN
            Reset soGripperR_Open;
            PulseDO soGripperR_Close;
        ELSE
            Hand_GripInward;
        ENDIF
    ENDPROC
    ...
    PROC rGrServoOpen()
        IF bSimulation THEN
            Reset soGripperR_Close;
            PulseDO soGripperR_Open;
        ELSE
            Hand_MoveTo 22;
        ENDIF
    ENDPROC
